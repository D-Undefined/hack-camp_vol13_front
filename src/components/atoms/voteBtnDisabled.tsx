...
export const VoteBtnDisabled: FC<IProps> = ({comment, votedComment}) => {
  return (
    <div className="">
      {
        <div className="flex justify-center items-center text-xl text-center text-gray-400">
          {
            votedComment?.is_up ? 
            <span className="p-1 bg-red-400 rounded-l-xl border border-gray-300 duration-300">
          ...
          <span className="px-2 bg-gray-200 border-y border-gray-300">{`${comment.vote_cnt}`}</span>
          {
            !votedComment?.is_up ? 
            <span className="p-1 bg-blue-400 rounded-r-xl border border-gray-300 duration-300">
